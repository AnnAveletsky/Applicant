namespace Applicant.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Applicant_AplicantID = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.Tag_TagId, t.Applicant_AplicantID })
                .ForeignKey("dbo.Tags", t => t.Tag_TagId, cascadeDelete: true)
                .ForeignKey("dbo.Applicants", t => t.Applicant_AplicantID, cascadeDelete: true)
                .Index(t => t.Tag_TagId)
                .Index(t => t.Applicant_AplicantID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TagApplicants", "Applicant_AplicantID", "dbo.Applicants");
            ...
            DropIndex("dbo.TagApplicants", new[] { "Applicant_AplicantID" });
